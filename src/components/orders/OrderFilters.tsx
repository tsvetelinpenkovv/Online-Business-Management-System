      ...
      <div className="lg:hidden space-y-3">
        ...
        <div className="grid grid-cols-2 sm:flex sm:flex-wrap sm:justify-center items-center gap-2">
          ...
          <Button 
            ...
            className={`${!connectixEnabled && !nekorektenEnabled ? 'col-span-2 sm:flex-1' : 'col-span-1 sm:w-auto'} h-9 bg-primary/10 hover:bg-primary/20 border-primary/30 text-foreground hover:text-foreground dark:hover:text-primary-foreground`}
          >
            <Warehouse className="w-4 h-4 mr-2" />
            Склад
          </Button>

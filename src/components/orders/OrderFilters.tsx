      ...
      <div className="hidden lg:flex items-center gap-3">
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button variant="outline" className="w-[130px] data-[state=open]:bg-primary data-[state=open]:text-primary-foreground data-[state=open]:border-primary">
      ...
      <div className="lg:hidden space-y-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="flex gap-2 w-full sm:w-auto">
            <Popover>
              <PopoverTrigger asChild>
                <Button variant="outline" className="flex-1 sm:flex-none sm:min-w-[140px] text-xs sm:text-sm data-[state=open]:bg-primary data-[state=open]:text-primary-foreground data-[state=open]:border-primary">

...
## 10. СТАТУС НА ОБАЖДАНЕ (НОВО!)

### 10.1 Какво е статус на обаждане?
Втора колона в таблицата с поръчки за проследяване на телефонни обаждания.

### 10.2 Налични статуси
| Статус | Описание | Цвят |
|--------|----------|------|
| Няма | Не е правен опит | Сив |
| Не вдига | Клиентът не отговаря | Червен |
| Зает | Линията е заета | Жълт |
| Грешен номер | Невалиден номер | Оранжев |
| Обратно обаждане | Очаква се обаждане | Лилав |
| Обаден | Осъществен контакт | Син |
| Потвърден | Поръчката е потвърдена | Зелен |

---

## 11. ТАБЛИЦА С ТОВАРИТЕЛНИЦИ (shipments)

...
export const SourceIcon = forwardRef<HTMLElement, SourceIconProps>(({ source, className = "w-5 h-5" }, ref) => {
  switch (source) {
    case 'google':
      return (
        <svg ref={ref as unknown as Ref<SVGSVGElement>} className={className} viewBox="0 0 24 24" fill="none">
    ...
    case 'facebook':
      return (
        <svg ref={ref as unknown as Ref<SVGSVGElement>} className={className} viewBox="0 0 24 24" fill="#1877F2">
    ...
    case 'custom_api':
      return (
        <svg ref={ref as unknown as Ref<SVGSVGElement>} className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">

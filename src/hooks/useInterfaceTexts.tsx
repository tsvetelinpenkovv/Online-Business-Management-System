...
import {
  ...
  Truck, Box, Users, Boxes, FileBox, Receipt, Tags, Phone, Mail,
  MapPin, Hash, Euro, ShoppingCart, Archive, Clipboard, AlertTriangle,
  TrendingUp, PieChart, Activity, Layers, FolderOpen, FileInput,
  FileOutput, ArrowLeftRight, ChevronDown,
} from 'lucide-react';

// Define available icons using individual imports (avoids bundling entire lucide-react)
